...
import com.shop.store.view.login.home.TabInforActivity;
...
public class HomeFragmentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (type == 1) {
            ...
            bh.ban.setImages(dataBanner).setImageLoader(new ImageLoader() {
                @Override
        ...
        if (type == 2) {
            ...
            for (int i = 0; i < channel.size(); i++) {
                ih.tab.addTab(ih.tab.newTab().setText(channel.get(i).getName()),false);
                }
        ...
        if (type == 3) {
            ...
            bh.brand_tv.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    class BannerHolder extends RecyclerView.ViewHolder {
        ...
        public BannerHolder(View itemView) {
            super(itemView);
            ban = itemView.findViewById(R.id.home_ban);
